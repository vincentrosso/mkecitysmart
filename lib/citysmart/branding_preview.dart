...
class _Chips extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Wrap(
    ...
    children: const [
      Chip(
        label: Text('Tow Alert'),
        avatar: Icon(Icons.local_shipping, size: 18),
      ),
      Chip(
        label: Text('Snow Emergency'),
        avatar: Icon(Icons.ac_unit, size: 18),
      ),
      Chip(
        label: Text('Reminder'),
        avatar: Icon(Icons.notifications_active, size: 18),
      ),
    ],
  );
}
...
class _Footer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Align(
      ...
      child: Text(
        'Smarter Cities. Connected Communities.',
        style: TextStyle(
          fontFamily: 'Poppins',
          fontWeight: FontWeight.w700,
