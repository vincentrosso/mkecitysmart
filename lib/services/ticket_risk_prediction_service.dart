...
class TicketRiskPredictionService {
  ...
  double predictRisk({
    ...
    final eventFactor = eventLoad.clamp(0, 1) * 0.35;
    final historyFactor = historicalDensity.clamp(0, 1) * 0.4;
    final noise = _locationNoise(latitude, longitude) * 0.1;

    final score = hourFactor + dayFactor + eventFactor + historyFactor + noise;
